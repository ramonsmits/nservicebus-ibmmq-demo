...
var host = Host.CreateDefaultBuilder(args)
    .ConfigureServices(services =>
    {
        services.AddOpenTelemetry()
            .ConfigureResource(r => r.AddService("Acme.Sales"))
    ...
    {
        var endpointConfiguration = new EndpointConfiguration("Acme.Sales");
        ...
        routing.RouteToEndpoint(typeof(ShipOrder), "Acme.Shipping");
        ...
        endpointConfiguration.RegisterMessageMutator(new EbcdicMessageMutator());
